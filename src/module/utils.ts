...
export function limitConcurrency<Callback extends (...unknown) => unknown>(fn: Callback): Callback {
    let limited = false;
...
export function initSkills(actor: SWNRCharacterActor, skillSet: keyof typeof skills): void {
