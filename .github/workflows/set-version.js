...
if (!tagVersion || !(tagVersion.startsWith('v') || tagVersion.startsWith('b'))) {
  ...
  version = tagVersion.substring(1); // strip the 'v'-prefix
  manifest.version = version
  manifest.download = `https://github.com/Spice-King/foundry-swnr/releases/download/${tagVersion}/swnr-v${version}.zip`
